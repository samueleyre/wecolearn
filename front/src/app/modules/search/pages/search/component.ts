...
@Component({
  ...
  public messages = {
    ...
    Peut-être que les profils suivant pourront aussi vous intéresser ?`,
    [SearchMeta.userLearnTags]: 'Nous avons sélectionné ces profils pour vous.',
    [SearchMeta.userLearnTagDomains]: 'Nous avons sélectionné ces profils pour vous.',
    [SearchMeta.userKnowTags]: 'Nous avons sélectionné ces profils pour vous.',
    [SearchMeta.userKnowTagDomains]: 'Nous avons sélectionné ces profils pour vous.',
  };
